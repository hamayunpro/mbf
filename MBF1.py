...
# LO KONTOL
logo='''
 \033[0;92m___  _________ ______  __  
\033[0;95m |  \/  || ___ \|  ___|/  | 
\033[0;96m | .  . || |_/ /| |_   `| | 
\033[0;92m | |\/| || ___ \|  _|   | | 
\033[0;91m | |  | || |_/ /| |    _| |_
\033[0;93m \_|  |_/\____/ \_|    \___/
                            
\033[0;93mEDITOR > HAMAYUN                            
\033[0;92mGITHUB > HAMAYUN01
\033[0;94mWHTSP > 03428886288
\033[0;91mFACBOK> HAMAYUN KHAN '''
...
def yayanxd():
    ...
    try:
        ...
        print ' %s*%s WELCOME TO THE MBF1 TOOL ENJOY FREE CLONING...'%(O,N);time.sleep(2)
...
def info_tools():
    ...
    print '\n %s[%s>%s] 𝐄𝐃𝐈𝐓𝐎𝐑༆   : HAMAYUN KHAN.'%(N,H,N);time.sleep(0.07)
    print '\n %s[%s>%s] 𝐆𝐈𝐓𝐇𝐔𝐁༆    :HAMAYUN01'%(N,H,N);time.sleep(0.07)
    print '\n %s[%s>%s] 𝐖𝐡𝐚𝐭𝐒𝐀𝐏༆   : +923428886289'%(N,H,N);time.sleep(0.07)
    print '\n %s[%s>%s] 𝐅𝐀𝐂𝐄𝐁𝐎𝐎𝐊 : HAMAYUN KHAN'%(N,H,N);time.sleep(0.07)
        ...
        if ___yayanganteng___ in ('Y', 'y'):
            ...
            while True:
                ...
                if pwek == '':
                    ...
                    print ' [%s2%s]. method mbasic (OK IDS)'%(O,N)
